 ...
 */
CJumpscaretrap::CJumpscaretrap(void)
{
 ...
 */
CJumpscaretrap::CJumpscaretrap(const glm::vec3 vec3Position,
 ...
 */
bool CJumpscaretrap::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::JUMPSCARETRAP);
 ...
 */
bool CJumpscaretrap::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CJumpscaretrap::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CJumpscaretrap::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CJumpscaretrap::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CJumpscaretrap::Update(const double dElapsedTime)
{
 ...
 */
void CJumpscaretrap::PreRender(void)
{
 ...
 */
void CJumpscaretrap::Render(void)
{
...
*/
void CJumpscaretrap::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CJumpscaretrap::PrintSelf(void)
{
