 ...
 */
CIncreaseDmg::CIncreaseDmg(void)
{
 ...
 */
CIncreaseDmg::CIncreaseDmg(const glm::vec3 vec3Position,
 ...
 */
bool CIncreaseDmg::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CIncreaseDmg::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CIncreaseDmg::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CIncreaseDmg::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CIncreaseDmg::Update(const double dElapsedTime)
{
 ...
 */
void CIncreaseDmg::PreRender(void)
{
...
*/
void CIncreaseDmg::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CIncreaseDmg::PrintSelf(void)
{
