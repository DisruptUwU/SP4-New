 ...
 */
CDoorLvl3::CDoorLvl3(const glm::vec3 vec3Position,
 ...
 */
bool CDoorLvl3::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::DOORLVL3);
 ...
 */
bool CDoorLvl3::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CDoorLvl3::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CDoorLvl3::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CDoorLvl3::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CDoorLvl3::Update(const double dElapsedTime)
{
...
*/
void CDoorLvl3::PostRender(void)
{
