 ...
 */
CHealthup::CHealthup(const glm::vec3 vec3Position,
 ...
 */
bool CHealthup::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::HEALTHPOWER);
 ...
 */
bool CHealthup::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CHealthup::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CHealthup::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CHealthup::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CHealthup::Update(const double dElapsedTime)
{
...
*/
void CHealthup::PostRender(void)
{
