 ...
 */
CChestZone::CChestZone(const glm::vec3 vec3Position,
 ...
 */
bool CChestZone::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::CHEST_ZONE);
 ...
 */
bool CChestZone::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CChestZone::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CChestZone::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CChestZone::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CChestZone::Update(const double dElapsedTime)
{
 ...
 */
void CChestZone::PreRender(void)
{
...
*/
void CChestZone::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CChestZone::PrintSelf(void)
{
