 ...
 */
CBearTrap::CBearTrap(const glm::vec3 vec3Position,
 ...
 */
bool CBearTrap::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::BEARTRAP);
 ...
 */
bool CBearTrap::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CBearTrap::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CBearTrap::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CBearTrap::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CBearTrap::Update(const double dElapsedTime)
{
...
*/
void CBearTrap::PostRender(void)
{
