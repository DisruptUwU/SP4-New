 ...
 */
CSpeed::CSpeed(const glm::vec3 vec3Position,
 ...
 */
bool CSpeed::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::SPEEDPOWER);
 ...
 */
bool CSpeed::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CSpeed::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CSpeed::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CSpeed::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CSpeed::Update(const double dElapsedTime)
{
