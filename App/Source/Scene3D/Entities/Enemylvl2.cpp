 ...
 */
CEnemylvl2::CEnemylvl2(	const glm::vec3 vec3Position,
 ...
 */
bool CEnemylvl2::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::ENEMYLVL2);
 ...
 */
void CEnemylvl2::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CEnemylvl2::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CEnemylvl2::SetProjection(const glm::mat4 projection)
{
 ...
 */
void CEnemylvl2::AttachCamera(CCamera* cCamera)
{
 ...
 */
bool CEnemylvl2::IsCameraAttached(void)
{
	if (cCamera)
		return true;
	return false;
 ...
 */
void CEnemylvl2::SetWeapon(const int iSlot, CWeaponInfo* cWeaponInfo)
{
	if (iSlot == 0)
 ...
 */
CWeaponInfo* CEnemylvl2::GetWeapon(void) const
{
	if (iCurrentWeapon == 0)
...
/**
 ...
 @param iSlot A const int variable which contains the weapon info to check for. 0 == Primary, 1 == Secondary
 */
void CEnemylvl2::SetCurrentWeapon(const int iSlot)
{
...
/**
 ...
 @return A bool value
 */
bool CEnemylvl2::DischargeWeapon(void) const
{
 ...
 */
void CEnemylvl2::ProcessMovement(const ENEMYMOVEMENT direction, const float deltaTime)
{
 ...
 */
void CEnemylvl2::ProcessRotate(const float fXOffset)
{
	// Update the yaw
 ...
 */
bool CEnemylvl2::Update(const double dElapsedTime)
{
 ...
 */
void CEnemylvl2::PreRender(void)
{
 ...
 */
void CEnemylvl2::PostRender(void)
{
	// If this entity is not active, then skip this
	if (bStatus == false)
	{
 ...
 */
void CEnemylvl2::UpdateEnemyVectors(void)
{
 ...
 */
void CEnemylvl2::Constraint(void)
{
	// Get the new height
 ...
 */
void CEnemylvl2::UpdateFrontAndYaw(void)
{
