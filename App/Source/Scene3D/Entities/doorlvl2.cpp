 ...
 */
CDoorlvl2::CDoorlvl2(const glm::vec3 vec3Position,
 ...
 */
bool CDoorlvl2::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::DOORLVL2);
 ...
 */
bool CDoorlvl2::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CDoorlvl2::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CDoorlvl2::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CDoorlvl2::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CDoorlvl2::Update(const double dElapsedTime)
{
...
*/
void CDoorlvl2::PostRender(void)
{
