 ...
 */
CCoin::CCoin(const glm::vec3 vec3Position,
 ...
 */
bool CCoin::Init(void)
{
	// Call the parent's Init()
	CSolidObject::Init();

	// Set the type
	SetType(CEntity3D::TYPE::COIN);

	if (LoadModelAndTexture("Models/Objects/coin.obj",
		"Image/Terrain/textures/volcano.jpg",
 ...
 */
bool CCoin::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CCoin::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CCoin::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CCoin::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CCoin::Update(const double dElapsedTime)
{
