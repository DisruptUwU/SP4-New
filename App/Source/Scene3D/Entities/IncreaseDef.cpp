 ...
 */
CIncreaseDef::CIncreaseDef(void)
{
 ...
 */
CIncreaseDef::CIncreaseDef(const glm::vec3 vec3Position,
 ...
 */
bool CIncreaseDef::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CIncreaseDef::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CIncreaseDef::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CIncreaseDef::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CIncreaseDef::Update(const double dElapsedTime)
{
 ...
 */
void CIncreaseDef::PreRender(void)
{
...
*/
void CIncreaseDef::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CIncreaseDef::PrintSelf(void)
{
